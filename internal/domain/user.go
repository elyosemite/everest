...
func NewUser(name, email, document string, address string) (*User, error) {
...
// Método privado (só visível dentro do package domain)
...
func (u *User) AddAccount(account *Account) error {
	if account == nil {
...
func (u *User) Accounts() []Account {
	accounts := make([]Account, len(u.accounts))
